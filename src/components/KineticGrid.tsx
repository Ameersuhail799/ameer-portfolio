 ...
 *
 * A reactive HTML5 Canvas dot & mesh grid that pulls toward the cursor within a chosen
 * radius with spring physics and an optional cursor motion trail.
 */
export default function KineticGrid(props: KineticGridProps) {
    ...
    useEffect(() => {
        ...
        // Window-level mouse tracking for global responsiveness
